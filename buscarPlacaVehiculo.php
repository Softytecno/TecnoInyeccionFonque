...
if (!isset($correo)) {
  ...
  ob_end_flush();
    ...
    $query = "SELECT * FROM tb_vehicles ";

    if (isset($_POST['consulta'])) {
    	$q = $conn->real_escape_string($_POST['consulta']);
    	$query = "SELECT * FROM tb_vehicles WHERE vehi_license_plate  LIKE '%$q%' ";
    }
            ...
            while ($fila = $resultado->fetch_assoc()) {
                ...
                <tbody>
                  <tr>
                    ...
                    <td align="center"><a href="editarVehiculo.php?placa='.$fila['vehi_license_plate'].'" class="btn btn-warning"> <i class="fas fa-edit"></i> </a> </td>
                  </tr>
                  ';
