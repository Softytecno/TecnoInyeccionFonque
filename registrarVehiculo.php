                ...
                <div class="card card-body" style="border-radius: 5px; box-shadow: 0 0 30px rgb(0, 0, 0, .568);">
                    <form action="guardarVehiculo.php" method="post" >
                        <div class="alert alert-light col-md" role="alert" style="text-align: center;">
                            <a class="alert-link">
                                <h5 style="font-family:'Courier New'; font-size: 22px;">REGISTRAR VEHICULO</h5>
                            </a>
                        </div>
                        ...
                        <?php
                        if (isset($_SESSION['placa_existente'])) {
                          echo '<div class="alert alert-danger alert-dismissible" id="placaExistente">';
                          echo 'La placa ya existe en la base de datos.';
                          echo '<button type="button" class="close" data-dismiss="alert" aria-label="Close">';
                          echo '<span aria-hidden="true">&times;</span>';
                          echo '</button>';
                          echo '</div>';
                          unset($_SESSION['placa_existente']);
                        }
                        ?>
                        ...
                        <div class="form-group">
                            <input type="text" name="linea" class="form-control" placeholder="Linea" autofocus="">
                        </div>
                        <div class="form-group">
                            <input type="text" name="modelo" class="form-control" placeholder="Modelo" autofocus="">
                        </div>
                        <div class="form-group">
                            <input type="text" name="cilindraje" class="form-control" placeholder="Cilindraje" autofocus="">
                        </div>
